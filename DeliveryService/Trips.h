...
public:
	...
	const std::array<std::array<std::array<std::array<int, STATION>, FLEET>, DAY>, SCENARIO>& y3() const { return _y3; }
	const std::array<std::array<std::array<std::array<int, TASK>, FLEET>, DAY>, SCENARIO>& x4() const { return _x4; }
	const std::array<std::array<std::array<std::array<int, TASK>, FLEET>, DAY>, SCENARIO>& y4() const { return _y4; }
	...
	std::array<std::array<std::array<std::array<int, STATION>, FLEET>, DAY>, SCENARIO>& y3() { return _y3; }
	std::array<std::array<std::array<std::array<int, TASK>, FLEET>, DAY>, SCENARIO>& x4() { return _x4; }
	std::array<std::array<std::array<std::array<int, TASK>, FLEET>, DAY>, SCENARIO>& y4() { return _y4; }
...
private:
	...
	std::array<std::array<std::array<std::array<int, STATION>, FLEET>, DAY>, SCENARIO> _y3;
	std::array<std::array<std::array<std::array<int, TASK>, FLEET>, DAY>, SCENARIO> _x4;
	std::array<std::array<std::array<std::array<int, TASK>, FLEET>, DAY>, SCENARIO> _y4;
};
